        ...
        <header className="sticky top-0 z-[100] bg-bg-base/85 backdrop-blur-xl border-b border-border">
          <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
            ...
            <nav className="flex items-center gap-4">
              <a href="https://github.com/mapas48/skill-it" target="_blank" rel="noreferrer" className="flex items-center gap-1.5 text-sm text-text-muted px-3.5 py-1.5 rounded-radius-sm border border-border transition-all duration-200 hover:opacity-75">
